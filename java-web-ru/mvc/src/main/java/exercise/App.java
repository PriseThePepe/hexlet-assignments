...
public final class App {
    ...
    public static Javalin getApp() {
        ...
        // BEGIN
        app.get(NamedRoutes.editPostPath("{id}"), PostsController::edit); // Показать страницу редактирования поста
        app.post(NamedRoutes.updatePostPath("{id}"), PostsController::update); // Обновить пост по ID
        // END
